...
class SntpClient {
    ...
    fun requestTime(host: String, timeout: Int): Boolean {
        ...
        try {
            ...
            val request = DatagramPacket(buffer,
                    buffer.size, address, NTP_PORT)
            ...
            Log.d(TAG, "RequestTime:" + Date(requestTime))
            ...
            // read the response
            val response = DatagramPacket(buffer,
                    buffer.size)
            ...
            // extract the results
            val originateTime = readTimeStamp(buffer,
            ...
            // = (2 * skew)/2 = skew
            val clockOffset = (receiveTime - requestTime + (transmitTime - System.currentTimeMillis())) / 2
            ...
            ntpTime = System.currentTimeMillis() + clockOffset
    ...
    private fun read32(buffer: ByteArray, offset: Int): Long {
        ...
        return ((i0.toLong() shl 24) + (i1.toLong() shl 16) + (i2.toLong() shl 8)
                + i3.toLong())
    }
    ...
    companion object {
        ...
        val SJTU = "ntp.sjtu.edu.cn"    //delay = 81ms
        val ALI = "ntp2.aliyun.com"     //delay = 43ms
